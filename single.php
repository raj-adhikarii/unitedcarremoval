                    ...
                    <div class="car-removal">
                        ...
                        <div class="recent-d-flex">
                            <div class="image-wrapper">
                                <span class="icon-list"><a href="/single.html"><img src="<?php echo get_theme_file_uri('/img/cash-rate.png'); ?>"></a></span>
                            </div>
                            <div class="con-wrapper">
                                <div class="iconlist">
                                    <h4><span class="icon-list-content"><a href="/single.html">Cash for Cars Penrith</a></span></h4>
                                    <span class="icon-list-content">we make it easy because we come wherever you may be located...</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="recent-d-flex">
                            <div class="image-wrapper">
                                <span class="icon-list"><a href="/single.html"><img src="/img/cash-rate.png"></a></span>
                            </div>
                            <div class="con-wrapper">
                                <div class="iconlist">
                                    <h4><span class="icon-list-content"><a href="/single.html">Cash for Cars Penrith</a></span></h4>
                        ...
                        <div class="categories">
                            <h3>Categories</h3>
                            <div class="iconlist">
                                <h5><span class="icon-list"><img src="/img/icon-list.svg"></span><span class="icon-list-content"><a href="/single.html">Australian green</a></span></h5>
                                <h5><span class="icon-list"><img src="/img/icon-list.svg"></span><span class="icon-list-content"><a href="/single.html">Offer cars</a></span></h5>
                                <h5><span class="icon-list"><img src="/img/icon-list.svg"></span><span class="icon-list-content"><a href="/single.html">Cash for Cah5</a></span></h5>
                                <h5><span class="icon-list"><img src="/img/icon-list.svg"></span><span class="icon-list-content"><a href="/single.html">Australian green</a></span></h5>
                                <h5><span class="icon-list"><img src="/img/icon-list.svg"></span><span class="icon-list-content"><a href="/single.html">Offer cars</a></span></h5>
                                <h5><span class="icon-list"><img src="/img/icon-list.svg"></span><span class="icon-list-content"><a href="/single.html">Cash for Cah5</a></span></h5>
                            </div>
                        ...
                        <div class="car-removal c-info">
                            <h3>Contact Info</h3>
                                <div class="address-wrap">
                                    <div class="phone">
                                        <div class="iconlist">
                                            <h4><span class="icon-list"><img src="/img/icon-phone.svg"></span><span class="icon-list-content">Phone</span></h4>
                                    ...
                                    <div class="email">
                                        <div class="iconlist">
                                            <h4><span class="icon-list"><img src="/img/mail.svg"></span><span class="icon-list-content">Email</span></h4>
                                    ...
                                    <div class="address">
                                        <div class="iconlist">
                                            <h4><span class="icon-list"><img src="/img/address.svg"></span><span class="icon-list-content">Address</span></h4>
