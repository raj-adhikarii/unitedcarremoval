            ...
            <div class="container">
                <div class="footer-col-wrapper">
                    ...
                    <div class="footer-col">
                        ...
                        <ul class="footer-list">
                            <li class="footer-menu-link"><a href="#">0487002222</a></li>
                            <li class="footer-menu-link"><a href="#">info@unitedcarremoval.com.au</a></li>
                            <li class="footer-menu-link"><a href="#">59 Lisbon St, Fairfield East, NSW, 2165</a></li>
                            <li class="footer-menu-link"><a href="#">59 Wallsend Rd, Sandgate NSW 2304</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="copyright">
            <div class="container">
                <div class="copyright-wraper">
                    ...
                    <div class="social">
                        <ul>
                            <li class="social-icon"><a href="#"><img src="<?php echo get_theme_file_uri('/img/facebook.svg'); ?>" alt="facebook"></a></li>
                            <li class="social-icon"><a href="#"><img src="<?php echo get_theme_file_uri('/img/twiller.svg'); ?>" alt="twitter"></a></li>
                            <li class="social-icon"><a href="#"><img src="<?php echo get_theme_file_uri('/img/insta.svg'); ?>" alt="Instagram"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
